...
class LanguagesTest(unittest.TestCase):
    ...
    def setUp(self):
        self.tuple_derived = Languages([Language['Python 3'], Language['C#']])
        for x in self.tuple_derived:
            self.assertIsInstance(x, Language)
        self.tuple = (Language['Python 3.3, 3.4, 3.5, 3.6'], Language['C#'])
    ...
    def test_contains(self):
        self.assertTrue('CS' in self.tuple_derived)
